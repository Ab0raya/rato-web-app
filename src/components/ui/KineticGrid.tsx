...
interface KineticGridProps {
  children?: ReactNode;
  className?: string;
  globalColor?: "default" | "rato" | "monochrome";
  contained?: boolean;
}
...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        rato: {
          bg: "#0E0E11",
          lineActive: { r: 255, g: 96, b: 57, a: 0.85 },
          nodeActive: { r: 255, g: 96, b: 57, a: 1.0 },
          glow: "255,96,57",
          ripple: "255,120,80",
        },
        default: {
  ...
  useEffect(() => {
    ...
    const targetEl = contained && container ? container : window;
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative w-full overflow-hidden bg-[#0E0E11]",
        className
      )}
    >
      <canvas
