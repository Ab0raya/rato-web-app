  ...
  return (
    <section className="relative min-h-[92vh] overflow-hidden flex items-center">
      ...
      <KineticGrid
        globalColor="rato"
        contained={true}
        className="w-full min-h-[92vh] pt-32 pb-24 sm:pt-40 sm:pb-32 flex items-center relative"
      >
        {/* Ambient Center Glow */}
        ...
        <div className="absolute top-1/3 right-10 rtl:right-auto rtl:left-10 w-96 h-96 bg-[#FF6039]/6 rounded-full blur-[100px] pointer-events-none -z-10" />

        {/* Bottom smooth fade vignette into next section */}
        <div className="absolute bottom-0 left-0 right-0 h-36 bg-gradient-to-t from-[#0E0E11] via-[#0E0E11]/80 to-transparent pointer-events-none z-10" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            >
              {/* Launch Date Badge with Interactive Hint */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1A1A1E]/80 backdrop-blur-xl border border-[#2A2A2F] text-xs font-semibold text-white shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start rtl:lg:justify-start gap-4 pt-2">
                ...
                <a
                  href="#how-it-works"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#1A1A1E]/80 hover:bg-[#222228] text-white font-medium text-sm px-7 py-4 rounded-full border border-[#2A2A2F] hover:border-[#FF6039]/40 backdrop-blur-xl transition-all active:scale-[0.98]"
                >
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -top-4 -left-6 sm:-left-12 rtl:-left-auto rtl:-right-6 rtl:sm:-right-12 z-20 hidden sm:flex items-center gap-3 p-3.5 rounded-2xl bg-[#1A1A1E]/90 backdrop-blur-2xl border border-[#2A2A2F] shadow-2xl"
              >
              ...
              <motion.div
                ...
                className="absolute top-1/3 -right-6 sm:-right-12 rtl:-right-auto rtl:-left-6 rtl:sm:-left-12 z-20 hidden sm:flex items-center gap-3 p-3.5 rounded-2xl bg-[#1A1A1E]/90 backdrop-blur-2xl border border-[#2A2A2F] shadow-2xl"
              >
                <div className="w-8 h-8 rounded-xl bg-[#FF6039]/15 flex items-center justify-center text-[#FF6039]">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -right-4 sm:-right-8 rtl:-right-auto rtl:-left-4 rtl:sm:-left-8 z-20 hidden sm:flex items-center gap-3 p-4 rounded-2xl bg-[#161616]/95 backdrop-blur-2xl border border-[#FF6039]/40 shadow-2xl"
              >
                <div className="text-left rtl:text-right">
