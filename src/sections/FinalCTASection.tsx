...
export const FinalCTASection: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden text-center bg-[#0E0E11]">
      <KineticGrid
        globalColor="rato"
        contained={true}
        className="py-32 sm:py-40 text-center relative"
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-20">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1A1A1E]/90 backdrop-blur-xl border border-[#2A2A2F] text-xs font-semibold text-white shadow-sm"
          >
          ...
          >
            ...
            <a
              href="#instant-meal"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#1A1A1E]/80 hover:bg-[#222228] text-white font-medium text-sm px-8 py-4 rounded-full border border-[#2A2A2F] hover:border-[#FF6039]/40 backdrop-blur-xl transition-all active:scale-[0.98]"
            >
